...
NS_GENERIC_FACTORY_CONSTRUCTOR(nsHandleImpl)
...
static const mozilla::Module::CIDEntry kSampleCIDs[] = {
	{ &kNS_SAMPLE_CID, false, NULL, nsHandleImplConstructor },
	{ NULL }
};
...
static const mozilla::Module::ContractIDEntry kSampleContracts[] = {
	{ NS_XPCONN_CONTRACTID, &kNS_SAMPLE_CID },
	{ NULL }
};
...
static const mozilla::Module::CategoryEntry kSampleCategories[] = {
	{ "my-category", "my-key", NS_XPCONN_CONTRACTID },
	{ NULL }
};
