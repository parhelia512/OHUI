...
/* VOID:INT,INT */
extern void gtkmozembed_VOID__INT_INT (GClosure     *closure,
                                       GValue       *return_value,
                                       guint         n_param_values,
                                       const GValue *param_values,
                                       gpointer      invocation_hint,
...
/* VOID:POINTER,UINT */
extern void gtkmozembed_VOID__POINTER_UINT (GClosure     *closure,
                                            GValue       *return_value,
                                            guint         n_param_values,
                                            const GValue *param_values,
                                            gpointer      invocation_hint,
...
/* BOOL:POINTER */
extern void gtkmozembed_BOOLEAN__POINTER (GClosure     *closure,
                                          GValue       *return_value,
                                          guint         n_param_values,
                                          const GValue *param_values,
                                          gpointer      invocation_hint,
                                          gpointer      marshal_data);
#define gtkmozembed_BOOL__POINTER	gtkmozembed_BOOLEAN__POINTER
